...
public class Tela_CarrinhoTESTE extends javax.swing.JFrame {
    ...
    public Tela_CarrinhoTESTE() throws FontFormatException, IOException {
    ...
    private void initComponents() {
        ...
        scrollbar.getAccessibleContext().setAccessibleParent(this);
...
//---------------------------------------------------------------------------------------------------------------------------------
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_CarrinhoTESTE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new Tela_CarrinhoTESTE().setVisible(true);
                } catch (FontFormatException ex) {
                    Logger.getLogger(Tela_CarrinhoTESTE.class.getName()).log(Level.SEVERE, null, ex);
