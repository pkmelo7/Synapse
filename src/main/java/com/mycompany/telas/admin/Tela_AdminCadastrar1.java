...
public class Tela_AdminCadastrar1 extends javax.swing.JFrame {
    ...
    //Declaração de métodos
        ...
        public void abrirCadastrarUser() throws FontFormatException, IOException
        {
            Tela_AdminCadastrarUser CadastraUser = new Tela_AdminCadastrarUser();
    ...
    public Tela_AdminCadastrar1() throws FontFormatException, IOException {
    ...
    private void initComponents() {
        ...
        String message = "O que gostaria de cadastrar?";
        typingEffect(messageLabel1, message, buttonUsuarios, buttonCursos, buttonVoltar);
        ...
        buttonUsuarios.setBounds(50, 295, 350, 90);
        ...
        buttonCursos.setBounds(50, 445, 290, 90);
...
private static void typingEffect(JLabel label, String message, JButton bt1, JButton bt2, JButton bt3) 
{
...
//---------------------------------------------------------------------------------------------------------------------------------
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_AdminCadastrar1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Tela_AdminCadastrar1().setVisible(true);
                } catch (FontFormatException ex) {
                    Logger.getLogger(Tela_AdminCadastrar1.class.getName()).log(Level.SEVERE, null, ex);
                } catch (IOException ex) {
                    Logger.getLogger(Tela_AdminCadastrar1.class.getName()).log(Level.SEVERE, null, ex);
