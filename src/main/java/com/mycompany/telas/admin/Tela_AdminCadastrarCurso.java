...
//---------------------------------------------------------------------------------------------------------------------------------
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_AdminCadastrarCurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Tela_AdminCadastrarCurso().setVisible(true);
                } catch (FontFormatException ex) {
                    Logger.getLogger(Tela_AdminCadastrarCurso.class.getName()).log(Level.SEVERE, null, ex);
                } catch (IOException ex) {
                    Logger.getLogger(Tela_AdminCadastrarCurso.class.getName()).log(Level.SEVERE, null, ex);
